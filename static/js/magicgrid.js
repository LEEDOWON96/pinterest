...
/**
 * <MAGICGRID> __articleapp/list.html 파일과 연결__
 * @author emmanuelolaojo
 * @since 11/11/18
 * 참고1) https://jsfiddle.net/eolaojo/4pov0rdf/ --> list.html
 * 참고2) https://github.com/e-oj/Magic-Grid/blob/master/dist/magic-grid.cjs.js --> magicgrid.js
 */
...
// list 레이아웃 위치 정돈
var masonnrys = document.getElementsByTagName("img");
for (let i = 0; i < masonnrys.length; i++) {
    masonnrys[i].addEventListener('load', function () {
